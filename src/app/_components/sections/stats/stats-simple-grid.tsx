        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              ...
              >
                Streamline Your Success Story with AutomationNation
              </h2>
              <p
              ...
              >
                Effortlessly automate your marketing, sales, and admin tasks. Subscribe to our all-in-one service for seamless workflow automation!
              </p>
            </div>
            <dl
